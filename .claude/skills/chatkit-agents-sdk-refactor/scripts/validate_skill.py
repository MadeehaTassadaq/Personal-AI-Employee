#!/usr/bin/env python3
"""
Validate the ChatKit + Agents SDK Refactor skill before packaging
"""
...
def validate_skill():
    ...
    if not any(trigger in desc_lower for trigger in ["when", "use", "help", "assist", "refactor", "chatkit", "agents"]):
